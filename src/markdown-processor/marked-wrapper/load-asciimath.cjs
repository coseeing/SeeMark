...
//
// Keeping the requires inside the function defers that evaluation to the
// first actual AsciiMath conversion: merely importing SeeMark (and rendering
// LaTeX/Nemeth) never touches the shim. Converting AsciiMath under an
// ESM-strict bundler still throws — an upstream mathjax-full limitation,
// documented in the README; `enableAsciimath: false` avoids it entirely.
//
